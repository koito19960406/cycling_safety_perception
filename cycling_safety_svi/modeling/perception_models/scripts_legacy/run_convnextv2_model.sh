...
# Script to train using the facebook/convnextv2-tiny-22k-224 model from Hugging Face
# Uses feature extraction from intermediate layers rather than ImageNet classification logits
...
OUTPUT_DIR="${BASE_OUTPUT_DIR}/convnextv2_model_${TIMESTAMP}"
mkdir -p ${OUTPUT_DIR}
...
# Path to the ConvNextV2 configuration YAML file
CONFIG_FILE="${SCRIPT_DIR}/configs/convnextv2_config.yaml"
TMP_CONFIG_FILE="${OUTPUT_DIR}/convnextv2_config_${TIMESTAMP}.yaml"
...
# Run the training script with ConvNextV2 model
